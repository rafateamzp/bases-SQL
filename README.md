...
Este proyecto consiste en el desarrollo de un catálogo digital para una plataforma ficticia de peliculas llamada StreamFlix. El objetivo es diseñar e implementar una base de datos MySQL que permita almacenar, consultar y gestionar información sobre películas.
